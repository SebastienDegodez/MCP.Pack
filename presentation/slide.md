...
## 🏗️ Configuration dans le Startup
...
```csharp
builder.WithMcpServer(args)
    .WithToolsFromAssembly()      // Scan automatique des Tools
    .WithResourcesFromAssembly()  // Scan automatique des Resources  
    .WithPromptsFromAssembly();   // Scan automatique des Prompts
